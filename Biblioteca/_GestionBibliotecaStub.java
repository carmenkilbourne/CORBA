...
public class _GestionBibliotecaStub extends org.omg.CORBA.portable.ObjectImpl implements Biblioteca.GestionBiblioteca
{
  ...
  public Biblioteca.Libro[] mostrarTodosLosLibros ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("mostrarTodosLosLibros", true);
                $in = _invoke ($out);
  ...
  public Biblioteca.Libro[] mostrarLibrosCategoria (String categoria)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("mostrarLibrosCategoria", true);
                $out.write_string (categoria);
                $in = _invoke ($out);
                Biblioteca.Libro $result[] = Biblioteca.ListaLibrosHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                return mostrarLibrosCategoria (categoria        );
            } finally {
                _releaseReply ($in);
            }
